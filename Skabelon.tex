...
$\bullet$ Start Main GUI'en\\
$\bullet$ Tilføj en ny person til systemet (Et KEA ID er bare et navn for nu)\\
$\bullet$ Tilføj en ny device til databasen\\
$\bullet$ Lån en device\\
$\bullet$ vis udlånte devices\\
$\bullet$ Aflever devicen\\
$\bullet$ Vis gamle udlåninger\\
$\bullet$ Vis alle brugere i systemet\\
$\bullet$ Vis alle devices i systemet\\
$\bullet$ Vis alle ledige devices\\[0.1in]
