...
Vi har lavet et deployment diagram figur\ref{fig:DEP}, som viser vores systems implementering. Deployment diagrammet bliver brugt til at vise rune-time komponenter og nodes. \cite[p~256]{OOSE}\\
Databasen snakker sammen med programmet via SQL mens computeren tilgår databasen via programmet.
\begin{figure}[h!]
