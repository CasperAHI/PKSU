...
\includegraphics[width=0.9\textwidth]{deploymentdiagram}
  ...
  \centering
\end{figure} \\ \\
I figur 7 ses et deployment diagram. Diagrammet viser vores systems implementering. Vi har altså lavet en database, som taler sammen med programmet via SQL. Computeren tilgår programmet igennem en anden computer via en virtuel maskine. \\
